...
def compute_purity(clusters,total_points):
    ...
    for i in range(num_clusters):
        ...
        max_union = -sys.maxsize - 1
        for label in labelCounts:
            if max_union < labelCounts[label]:
                max_union = labelCounts[label]
...
def calcNMI(nmiMatrix):
    ...
    for i in range(row - 1):
        for j in range(col - 1):
            ...
            # STRART YOUR CODE HERE  #
            # ========================#
            logPart_I = (float(N) * nmiMatrix[i][j]) / (float(nmiMatrix[i][col - 1]) * nmiMatrix[row - 1][j])
            # ========================#
            #   END YOUR CODE HERE   #
            # ========================#
        ...
        # STRART YOUR CODE HERE  #
        # ========================#
            HOmega += nmiMatrix[row - 1][j]/float(N) * math.log(nmiMatrix[row - 1][j] / float(N))
        # ========================#
        #   END YOUR CODE HERE   #
        # ========================#
    ...
    # STRART YOUR CODE HERE  #
    # ========================#
        HC += nmiMatrix[i][col - 1]/float(N) * math.log(nmiMatrix[i][col - 1]/float(N))
    # ========================#
    #   END YOUR CODE HERE   #
    # ========================#
